...
import kitchenImg2 from "../../assets/sifting.jpg";
import kneadingImg from "../../assets/kneading.jpg";
  ...
  return (
    <section className="about-section">
      <img
        src={kitchenImg}
        width={500}
        alt="Bakery kitchen with baked goods on display"
      />
      ...
      <img
        src={kitchenImg2}
        width={600}
        alt="Sifting flour in bakery kitchen"
      />
      <p>
      ...
      <img src={kneadingImg} width={600} alt="Kneading dough in bakery" />
